...
| `MINIMAX_API_KEY` / `ANIMA_MINIMAX_API_KEY` | API | MiniMax Global chat key. MiniMax is preferred over OpenRouter when configured; defaults to `MiniMax-M2.7` at `https://api.minimax.io/v1` |
