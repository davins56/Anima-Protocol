...
| `novels-and-brief.jsonl` | gitignored | Combined inspect bundle. **Not** copied to `raw/` — brief-gold already lives in `listSeedExamples`. |
| `../raw/curated-novels.jsonl` | gitignored | Novel scenes only, merged by `prepare-finetune` |
