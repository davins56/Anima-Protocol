...
const KORRA_CHARACTERS = [
  {
    ...
    category: "warrior",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/korra.jpg`,
  ...
  },
  {
    ...
    category: "scientist",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/asami.jpg`,
  ...
  },
  {
    ...
    category: "warrior",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/mako.jpg`,
  ...
  },
  {
    ...
    category: "hero",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/bolin.jpg`,
  ...
  },
  {
    ...
    category: "mystic",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/tenzin.jpg`,
  ...
  },
  {
    ...
    category: "warrior",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/lin.jpg`,
  ...
  },
  {
    ...
    category: "villain",
    status: "standby",
    avatar_url: `${import.meta.env.BASE_URL}avatars/zaheer.jpg`,
  ...
  },
  {
    ...
    category: "mystic",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/jinora.jpg`,
...
const MARVEL_CHARACTERS = [
  {
    ...
    category: "scientist",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/tony.jpg`,
  ...
  },
  {
    ...
    category: "hero",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/steve.jpg`,
  ...
  },
  {
    ...
    category: "warrior",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/natasha.jpg`,
  ...
  },
  {
    ...
    category: "hero",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/thor.jpg`,
  ...
  },
  {
    ...
    category: "mystic",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/wanda.jpg`,
  ...
  },
  {
    ...
    category: "other",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/loki.jpg`,
  ...
  },
  {
    ...
    category: "hero",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/peter.jpg`,
  ...
  },
  {
    ...
    category: "hero",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/tchalla.jpg`,
  ...
  },
  {
    ...
    category: "scientist",
    status: "online",
    avatar_url: `${import.meta.env.BASE_URL}avatars/bruce.jpg`,
  ...
  },
  {
    ...
    category: "other",
    status: "standby",
    avatar_url: `${import.meta.env.BASE_URL}avatars/fury.jpg`,
...
async function fixBrokenAvatars() {
  ...
  try {
    const allSeed = [...KORRA_CHARACTERS, ...MARVEL_CHARACTERS];
    const byName = Object.fromEntries(allSeed.map((c) => [c.name, c.avatar_url]));
    const existing = await base44.entities.Character.list("-created_date", 200);
    for (const char of existing || []) {
      const isBroken = !char.avatar_url || char.avatar_url.includes("wikia.nocookie.net");
      if (isBroken && byName[char.name]) {
        await base44.entities.Character.update(char.id, { avatar_url: byName[char.name] });
      }
    }
    localStorage.setItem(AVATAR_FIX_KEY, "1");
    console.log("[Anima] Updated companion portraits.");
  } catch (err) {
    console.warn("[Anima] Avatar fix failed:", err.message);
  }
}

export async function seedCharactersIfNeeded() {
  if (localStorage.getItem(SEED_KEY)) {
    await fixBrokenAvatars();
    return;
  }
