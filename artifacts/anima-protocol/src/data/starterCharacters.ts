import type { AV } from '../types/character';

export interface SerenityMainProps {}

export default function SerenityMain(props: SerenityMainProps) {   // ← your component starts after imports
  // ...
}
...
export interface Character extends CharacterBase, CharacterIdentifier {
  description: string;
...
export interface SeedCharacter extends CharacterBase {
  universe?: string;
  category?: string;
  status?: string;
  personality?: string;
...
const AVATAR_BASE: string = "https://jthzmstxltsjvehzijsq.supabase.co/storage/v1/object/public/avatars/";
